    ...
    <div className="flex items-center justify-between max-sm:flex-col-reverse gap-y-10 lg:px-44 sm:mt-20">
      ...
      <div >
        ...
        <p className="my-6 text-[15px] text-gray-500">
          ...
          Id quidem eaque aliquam veritatis voluptate error velit.
        </p>
        <div>
          <input type="file" name="" id="upload1" hidden />
          <label className="inline-flex gap-3 px-8 py-3.5 rounded-full cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-500 m-auto hover:scale-105 transitional-all duration-700" htmlFor="upload1">
